...
<head>
    ...
    <title>Knave GmBH | Password Recovery</title>
...
<!-- MAIN -->
<section class="grid">
    <form action="" class="form panel--padded">
        <div class="node__item">
            <h2 class="form--heading">Forgotten Your Password?</h2>
            <span>Don't worry, we'll send a reset link to your e-mail.</span>
        </div>

        <fieldset class="form__fieldset">
            <label for="p_reset"></label>
            <input type="email" id="p_reset" name="usr_p_reset" aria-label="E-mail Reset Field" class="form__input"
                   placeholder="Enter your Email Address or Knave ID">
            <button type="submit" class="btn--warning">
                Reset Password <i class="fa fa-envelope"></i>
            </button>
        </fieldset>
    </form>
</section>
