...
<head>
    ...
    <title>Knave GmBH | Log In</title>

    <!-- Stylesheets -->
    <style><?php readfile(getcwd() . "/../critical/login-critical.css"); ?></style>
...
<section class="grid l__header">
    <h1 class="v-hidden panel--centered">Login Form</h1>
    <form action="login.php" method="post" class="form grid__col--8 panel--padded">

        <fieldset class="form__fieldset">
            <img src="../assets/images/logo/knave-redact.svg" class="img--logo" alt="Knave Inc Logo-Redacted">
            <h1 class="form--heading">Log In.</h1>


            <label for="u-name" class="form__label">Username</label>
            <input type="email" id="u-name" name="usr_name" class="form__input" placeholder="example@knavemail.com">
            <!-- grouped input -->
            <div class="form__input--grouped">
                <label for="u-pass" class="form__label">Password</label>
                <input type="password" id="u-pass" name="usr_pass" class="form__input" placeholder="Password">
                <span class="login--info">
                    <a href="recovery/pass_reset.php">Forgotten password?</a>
                </span>
            </div>

            <label for="login_remember"></label>
            <input type="checkbox" id="login_remember" name="usr_remember" value="login_remember"
                   class="form__checkbox"><label
                    for="login_remember" class="form__checkbox--label">Remember Me</label>
