...
<head>
    ...
    <!-- Stylesheets -->
    <style><?php readfile(getcwd() . "/../critical/signu-critical.css"); ?></style>
...
<!-- #MAIN -->
<section class="grid l__header">
    <form class="form panel--padded">
        <h2 class="form--heading">Sign Up -- It's FREE!</h2>
        <fieldset class="form__fieldset">
            <legend class="form__legend"><span class="form--num">1</span>Basic Info</legend>
            <label for="f-name" class="form__label--hidden">First Name</label>
            <!-- anything with fname or firstname detected by Wallet Pass Gen -->
            <input type="text" id="f-name" name="usr_fname" class="form__input" placeholder="First Name"><!--
            --><span class="form__input--subtext">e.g. Jonathan</span>

            <label for="l-name" class="form__label--hidden">Last Name</label>
            <input type="text" id="l-name" name="usr_lname" class="form__input" placeholder="Last Name"><!--
          --><span class="form__input--subtext">e.g. Snook</span>

            <label for="pass" class="form__label--hidden">Password</label>
            <input type="password" id="pass" name="usr_pass" class="form__input" placeholder="Password"><!--
            --><span class="form__input--subtext"><span class="form__input--subtext--cond">password must have</span> between 8-32 characters</span>

            <label for="pass_conf" class="form__label--hidden">Confirm Password</label>
            <input type="password" id="pass_conf" name="usr_pass_conf" class="form__input"
                   placeholder="Confirm Password"><!--
            --><span class="form__input--subtext">enter <span class="form__input--subtext--cond">password</span> again to confirm</span>

            <label for="email" class="form__label--hidden">E-mail</label>
            <input type="email" id="email" name="usr_email" class="form__input" placeholder="E-mail"><!--
            --><span class="form__input--subtext">e.g. example@knavemail.com</span>

            <label class="form__label">Gender</label>
            <input type="radio" id="gender_male" name="usr_gender" value="male" class="form__radio"><label
                    for="gender_male" class="form__radio--label">Male</label><br>
            <input type="radio" id="gender_female" name="usr_gender" value="female" class="form__radio"><label
                    for="gender_female" class="form__radio--label">Female</label><br>
            <input type="radio" id="gender_neuter" name="usr_gender" value="neuter" class="form__radio"><label
                    for="gender_neuter" class="form__radio--label">Prefer not to say</label><br>


            <label for="nationality" class="form__label">Nationality</label>
            <select id="nationality" name="usr_country" aria-label="Nationality" class="form__select">
        ...
        <fieldset class="form__fieldset">
            ...
            <select name="usr_job" id="job" aria-label="Job" class="form__select">
            ...
            <textarea name="usr_bio" id="bio" class="form__textarea" placeholder="Tell us a little about yourself..."
                      cols="auto" rows="5"></textarea>


            <label class="form__label">Interests</label>
            <input type="checkbox" id="audio_eng" name="usr_interest" value="audio_eng" class="form__checkbox"><label
                    for="audio_eng" class="form__checkbox--label">Audio Engineering</label><br>
            <input type="checkbox" id="gaming" name="usr_interest" value="gaming" class="form__checkbox"><label
                    for="gaming" class="form__checkbox--label">Gaming</label><br>
            <input type="checkbox" id="fitness" name="usr_interest" value="fitness" class="form__checkbox"><label
                    for="fitness" class="form__checkbox--label">Fitness</label>
        </fieldset>

        <p class="form__policy">By clicking Create Account, you agree to our <a href="#">Terms</a> and confirm that you
            have read our <a href="#">Data Policy</a>, including our <a href="#">Cookie Use Policy</a>. You may receive
