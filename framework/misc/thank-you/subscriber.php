...
<head>
    ...
    <!-- Stylesheets -->
    <style><?php readfile(getcwd() . "/../../critical/subscriber-critical.css"); ?></style>
...
<!-- Script for URL Redirect to Previous Page -->
...
<section class="grid panel--padded">
    <div class="ack--container">
        ...
        <header class="ack--header">One final step...</header>
        <p>We need you to confirm your subscription. A verification link has been sent to the e-mail address you
            provided. You may have to check
            your <b>Spam Folder</b> should no message be in your <b>Inbox</b> within the next <b>15 minutes</b>.
            <br>
            To complete the subscription process, please click the link available in the e-mail.
        </p>


        <div class="panel--padded">
            <a class="ack--redir" href="<?= $previous ?>">
