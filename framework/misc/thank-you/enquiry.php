...
<head>
    ...
    <title>Knave GmBH | Query Sent!</title>

    <!-- Stylesheets -->
    <style><?php readfile(getcwd() . "/../../critical/enquiry-critical.css"); ?></style>
...
<section class="grid panel--padded">
    <div class="ack--container">
        ...
        <header class="ack--header">Your enquiry has been sent!</header>
        <p>We would like to thank you for reaching out to us. Knave&reg; usually responds in 1-3 Business Days.
            <br>
            If you happen to need much quicker service, you can also try to reach our Customer Helpline on <b>(+233) 243
                469 211.</b>
            <br>
            Have a great day!
        </p>
